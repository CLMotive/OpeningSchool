...
Now we consider reflexive localizations (1-categorical ones lead to triangulated and
...
.\]
Then $\check{C}_\bullet(U /X)$ is a simplicial scheme, so $C_*(\check{C}_\bullet(U /X))$
is a simplicial complex of abelian groups and $C(C_*(\check{C}_\bullet(U /X)))$ is a
double complex. (??)
